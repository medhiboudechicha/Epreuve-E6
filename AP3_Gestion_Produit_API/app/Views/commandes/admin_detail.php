...
<h1>Commande n°<?= esc($commande['id_commande']) ?></h1>

<p style="margin-top:8px;">
    Date : <strong><?= esc($commande['date_commande']) ?></strong><br>
    Client : <strong><?= esc($commande['nom_utilisateur']) ?></strong><br>
...
<p style="margin-top:16px;">
    <a href="<?= base_url('admin/commandes') ?>" class="btn btn-secondary">Retour a la liste</a>
</p>
