    ...
    <table class="table" style="margin-top:20px;width:100%;border-collapse:collapse;">
        <thead>
            <tr>
                ...
                <th style="border-bottom:1px solid #e2e8f0;padding:8px;">Client</th>
        ...
        <tbody>
            <?php foreach ($commandes as $c) : ?>
                <tr>
                    ...
                    <td style="border-bottom:1px solid #e2e8f0;padding:8px;"><?= esc($c['nom_utilisateur']) ?></td>
                    <td style="border-bottom:1px solid #e2e8f0;padding:8px;"><?= esc($c['quantite']) ?></td>
                    <td style="border-bottom:1px solid #e2e8f0;padding:8px;">
                        <a href="<?= base_url('admin/commandes/detail/' . $c['id_commande']) ?>" class="link">
                            Voir le détail
                        </a>
                        |
                        <a href="<?= base_url('admin/commandes/delete/' . $c['id_commande']) ?>"
